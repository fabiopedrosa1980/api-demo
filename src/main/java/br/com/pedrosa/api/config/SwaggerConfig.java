...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("API Venda de Discos").description("")
                .contact(new Contact("Fabio Pedrosa", "https://github.com/fabiopedrosa1980", "bito.pedrosa@gmail.com"))
